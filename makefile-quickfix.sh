...
cd cpan && zip -r ../com/perlplebean.com ./lib/perl5/5.36.0/Net/DNS/Nameserver.pm && zip -r ../perlplebean.com ./lib/perl5/5.36.0/Net/DNS/Nameserver.pm && cd ..
#zip -r perlplebean.com lib/ bin/ cgi/ html/ tsv/
zip -r perlplebean.com bin/perlplebean
